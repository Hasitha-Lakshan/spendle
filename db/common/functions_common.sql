...
-- =========================================
CREATE OR REPLACE FUNCTION public.admin_soft_delete_user_profile(p_profile_id UUID)
RETURNS JSONB
LANGUAGE plpgsql
SECURITY DEFINER
...
GRANT EXECUTE ON FUNCTION public.admin_soft_delete_user_profile(UUID) TO authenticated;
